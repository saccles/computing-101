...
_start:
    ...
    mov r10, rax # Save socket file descriptor.
...
respond_to_requests_loop:

    # Accept first connection request on pending connection queue.
    mov rdi, r10 # sockfd = file descriptor referring to socket
    mov rsi, 0 # addr = NULL
    ...
    mov r8, rdi # Save file descriptor referring to connection.
